...
<p>A substring is <strong>almost-palindromic</strong> if it becomes a palindrome after removing <strong>exactly</strong> one character from it.</p>
...
<p>A <strong>palindrome</strong> is a <strong>non-empty</strong> string that reads the same forward and backward.</p>
